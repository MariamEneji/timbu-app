...
import WomensWatches from '@/components/WomenWatches';
import WomenShoes from '@/components/WomesShoes';
    ...
    <div className='px-2 md:px-20 py-6'>
      <div>
        <div className='flex justify-between items-center'>
          <div>
            <button onClick={onSneaker} className={sneaker ? 'border-b-2 border-[#A95D17] p-1 mr-2 cursor-pointer hover:scale-[1.1] transition-all ' : ' p-1 mr-2 cursor-pointer hover:scale-[1.1] transition-all ' }>Shoes</button>
            <button onClick={onShirt} className={shirt ? 'border-b-2 border-[#A95D17] p-1 mr-2 cursor-pointer hover:scale-[1.1] transition-all ' : ' p-1 mr-2 cursor-pointer hover:scale-[1.1] transition-all ' }>Dresses</button>
